...
/usr/local/kafka/bin/kafka-topics.sh --bootstrap-server localhost:9092 --topic new_topic --describe
...
/usr/local/kafka/bin/kafka-console-producer.sh --bootstrap-server localhost:9092 --topic new_topic_2
hello again!

# this time our topic has 3 partitions
/usr/local/kafka/bin/kafka-topics.sh --bootstrap-server localhost:9092 --list
/usr/local/kafka/bin/kafka-topics.sh --bootstrap-server localhost:9092 --topic new_topic_2 --describe
